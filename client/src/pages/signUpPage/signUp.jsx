        ...
        <div className='bg-black p-4 min-vh-100'>
            <Container>
                ...
                <div className=' d-flex w-50'>
                    ...
                    <div className="rounded-pill w-auto search_bar  px-2 border border-success">
                        <FaSearch className="theamColor " />
                        <input type="text" className='border-0 bg-transparent rounded-pill' />
                    </div>
                </div>
